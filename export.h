#ifndef __MAIN_ML_H__
#define __MAIN_ML_H__
...
#if !defined(PART_OF_MAIN) && \
    !defined(STATIC_LINK_MAIN) && \
    !defined(DYNAMIC_LINK_MAIN)
#define PART_OF_MAIN
#endif
...
#elif defined(STATIC_LINK_MAIN)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_MAIN)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for main
#define MLLIB_PRIVATE(x)
